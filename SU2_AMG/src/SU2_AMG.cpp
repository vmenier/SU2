/*!
 * \file SU2_AMG.cpp
 * \brief Main file of Mesh Adaptation Code (SU2_AMG).
...
int main(int argc, char *argv[]) {
  ...
  for (iZone = 0; iZone < nZone; iZone++) {
    ...
    config_container[iZone] = new CConfig(config_file_name, SU2_AMG, iZone, nZone, 0, VERB_HIGH);
  ...
  /*--- Exit the solver cleanly ---*/
	...
	cout << endl <<"------------------------- Exit Success (SU2_AMG) ------------------------" << endl << endl;
